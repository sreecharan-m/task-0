...
if(isset($_POST['create']))
{
  ...
  $sql="INSERT INTO events(username,event_name,dt,ti,add_note,header,body,footer,venue,hfc,hbc,bfc,bbc,ffc,fbc,private) VALUES('$usr','$event','$dt','$ti','$addnote','$header','$body','$footer','$venue','$hfc','$hbc','$bfc','$bbc','$ffc','$fbc','$pri')";
